...
DROP TABLE IF EXISTS `jornal_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `jornal_user` (
  `jornal_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  KEY `jornal_user_jornal_id_foreign` (`jornal_id`),
  CONSTRAINT `jornal_user_jornal_id_foreign` FOREIGN KEY (`jornal_id`) REFERENCES `jornals` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jornal_user`
--
...
INSERT INTO `notification_user` VALUES (1,3,1),(2,3,2),(3,3,3);
...
INSERT INTO `notifications` VALUES (1,'Увидомление №1','У вас новый отчет',0,NULL,'2023-10-21 12:53:35'),(2,'Увидомление №2','Вы пропустили мероприятие',0,NULL,'2023-10-21 12:53:33'),(3,'Увидомление №3','В 14:00 совещание',0,NULL,'2023-10-21 09:30:52');
...
CREATE TABLE `progress` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `progress_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
